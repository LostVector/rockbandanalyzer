 ...
 */
public class GVizLineChartPanel extends Panel {
    ...
    public GVizLineChartPanel(final String id) {
        super(id);
        ...
        add( new GVizHeaderContributor("linechart") );
    ...
    private class HeaderContributorImpl implements IHeaderContributor {
        public void renderHead(IHeaderResponse response) {
            ...
            js.append( "Wicket.visualizations['" + visualization.getMarkupId() + "'].drawLineChart( data, options );" );
